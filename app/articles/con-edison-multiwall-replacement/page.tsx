        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md px-8 py-10" style={{ lineHeight: "1.8" }}>
            ...
            <div className="border-t border-gray-200 mt-10 pt-6 flex items-center gap-4">
              ...
              <a
                href="https://www.facebook.com/sharer/sharer.php?u=https://www.pipeinpipetech.com/articles/con-edison-multiwall-replacement"
                target="_blank"
              ...
              <a
                href="https://twitter.com/intent/tweet?url=https://www.pipeinpipetech.com/articles/con-edison-multiwall-replacement&text=Con+Edison+Lines+Replaced+by+New+Multiwall+Piping+System"
                target="_blank"
                rel="noopener noreferrer"
