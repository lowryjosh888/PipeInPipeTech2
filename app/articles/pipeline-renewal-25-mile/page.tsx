...
export default function PipelineRenewal25Mile() {
  return (
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto px-6 pb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
            IT3 System Renews 25 Mile Pipeline
          </h1>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md px-8 py-10" style={{ lineHeight: "1.8" }}>
            ...
            <p className="text-gray-700 mb-4">
              The IT3 System's in-situ installation approach allowed for the renewal of a 25-mile pipeline corridor
              without the extensive excavation typically required for full pipeline replacement. This project stands as
              one of the largest single-run applications of the IT3 multiwall technology to date.
            </p>
            <p className="text-gray-700 mb-4">
              By utilizing the existing steel casing as the outer containment layer, the project team was able to
              significantly reduce both installation time and total project costs while achieving performance
              specifications that met or exceeded those of a new pipeline system.
            </p>
            <p className="text-gray-700 mb-6">
              The successful completion of this project further validated the IT3 System's scalability and its
              suitability for large-scale pipeline rehabilitation programs across diverse terrain and operating conditions.
            </p>
            ...
            <div className="border-t border-gray-200 mt-10 pt-6 flex items-center gap-4">
              ...
              <a
                href="https://www.facebook.com/sharer/sharer.php?u=https://www.pipeinpipetech.com/articles/pipeline-renewal-25-mile"
              ...
              <a
                href="https://twitter.com/intent/tweet?url=https://www.pipeinpipetech.com/articles/pipeline-renewal-25-mile&text=IT3+System+Renews+25+Mile+Pipeline"
