            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl p-6 text-center" style={{ background: "#0f1e35" }}>
                  <div className="text-4xl font-extrabold leading-none mb-1" style={{ color: "#f4c430" }}>160</div>
                ...
                <div className="rounded-xl p-6 text-center" style={{ background: "#0f1e35" }}>
                  <div className="text-4xl font-extrabold leading-none mb-1" style={{ color: "#f4c430" }}>2,600</div>
                  <div className="text-gray-400 uppercase tracking-wide mt-1" style={{ fontSize: "11px" }}>PSI</div>
